                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    ...
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Incentive</li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="amount" id="amount" class="form-control numberonly" value="{{$rowData->amount}}" maxlength="6" placeholder="Total Incentive"/>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="day" id="day" confirmation="false" class="form-select">
                                        ...
                                        @for($i=1;$i<=31;$i++)
                                            ...
                                            <option {{$rowData->day == $i?'selected':''}} value="{{$i}}">{{$i}}</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="month" id="month" confirmation="false" class="form-select">
                                        ...
                                        @foreach($month_array as $key => $month)
                                            ...
                                            <option {{$rowData->month == $key?'selected':''}} value="{{$key}}">{{$month}}</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="year" id="year" confirmation="false" class="form-select">
                                        ...
                                        @for($i=2024;$i<=2030;$i++)
                                            ...
                                            <option {{$rowData->year == $i?'selected':''}} value="{{$i}}">{{$i}}</option>
...
<script>
	...
	let saveDataURL = "{{url('/admin/edit-incentive/'.$row_id)}}";
