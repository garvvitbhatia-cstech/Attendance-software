        ...
        <div class="page-title">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Incentives list.</p>
            ...
            <div class="card">
               ...
               <!--begin::Card body-->
                ...
                <div class="card-body">
                    ...
                    <a href="{{url('/admin/add-incentive')}}" class="btn icon btn-sm btn-outline-success float-end">Add New Incentive</a>
    ...
    <div class="modal fade" id="uploadCsvModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <a href="{{url('/storage/sample-csv/incentive.csv')}}" target="_blank" class="btn btn-success">Download Sample CSV</a>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/admin/incentives_paginate') }}",
