                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <label for="basicInput">Half Day Time</label>

                                <input type="time" class="form-control" value="{!! $setting->halfday_time !!}" id="halfday_time" name="halfday_time">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <label for="basicInput">Absent Time</label>

                                <input type="time" class="form-control" value="{!! $setting->absent_time !!}" id="absent_time" name="absent_time">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <label for="basicInput">Holiday Allowed</label>

                                <input class="form-control numberonly" maxlength="2" type="text" value="{!! $setting->holiyday_allowed !!}" name="holiyday_allowed" id="holiyday_allowed" />
