      ...
      <div class="card">
         ...
         <div class="card-body">
            <form class="form w-100" id="updateForm" action="#">
               <div class="row">
                  <div class="col-md-6">
                     <input type="hidden" name="old_banner" value="{!! $userData->profile !!}" />
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-lg-6 fv-row fv-plugins-icon-container">
                           <div class="cropped" id="cropped">
                              <div class="cropped" id="cropped"><img src="{{URL::asset('public/admin/images/users/')}}/{!! $userData->profile !!}" width="150"></div>
                           </div>
                        </div>
                     </div>
                  </div>
