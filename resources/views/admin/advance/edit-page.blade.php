                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="user_id" id="user_id" class="form-select select2">
                                    ...
                                    @if(isset($user->id))
                                        <option selected value="{{$user->id}}">{{$user->name}} ({{ $user->emp_id}}) - ₹{{ $user->salary }}</option>
                                    @endif
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Amount" value="{{$rowData->amount}}" name="amount" id="amount">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="mode" id="mode" class="form-select" onchange="checkMode(this.value)">
                                    <option {{$rowData->mode == 'Full Amount'?'selected':''}} value="Full Amount">Full Amount</option>
                                    <option {{$rowData->mode == 'Installment'?'selected':''}} value="Installment">Installment</option>                                            
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4 installment_amt_div" {{$rowData->mode == 'Installment'?'style="display:block;':'style="display:none;'}}">
                            <div class="form-group">
                                <label for="basicInput">Installment Amount</label>
                                <input type="text" class="form-control" placeholder="Enter Installment Amount" value="{{$rowData->installment}}" name="installment" id="installment">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="basicInput">Date</label>
                                <input type="date" class="form-control" placeholder="Enter date" value="{{$rowData->date}}" name="date" id="date">
                            </div>
                        </div>
...
<script>
	...
	let saveDataURL = "{{url('/admin/edit-advance/'.$row_id)}}";
