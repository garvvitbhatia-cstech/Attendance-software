    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Employee Advance Management</h3>
                <p class="text-subtitle text-muted">Employee Advance list.</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url('/admin')}}">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Employee Advance</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
           <!--begin::Card body-->
            <div class="card-body">
                ...
                <form id="searchForm" name="searchForm" class="float-start">
                    <div class="d-flex align-items-center  w-md-800px">
                        ...
                        <div class="position-relative col-12 col-md-3">
                            <input id="employee_id" name="employee_id" confirmation="false" class="form-control" placeholder="Search By Employee">
                        </div>
                        <div class="position-relative col-12 col-md-3">
                            <input type="date" name="from_date" confirmation="false" id="from_date" class="form-control"/>
                        </div>
                        <div class="position-relative col-12 col-md-3">
                            <input type="date" name="to_date" confirmation="false" id="to_date" class="form-control"/>
                        </div>
                        <!--end::Input group-->
                        <!--begin:Action-->
                ...
                <a href="{{url('/admin/add-advance')}}" class="btn icon btn-sm btn-outline-success float-end">Add New Advance</a>
            </div>
            <!--end::Card body-->
        </div>
    </section>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/admin/advance_paginate') }}",
