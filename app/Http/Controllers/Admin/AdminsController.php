    ...
    public function addPage(Request $request) {
        ...
        if ($request->input()) {
            ...
            if ($validator->fails()) {
                ...
                echo json_encode(array('heading' => 'Success', 'msg' => 'Admin details added successfully'));
                die;
            }
        }
        ...
        if ($request->input()) {
            ...
            if ($validator->fails()) {
                ...
                if (self::$User->ExistingRecordUpdate($request->input('email'), $RowID)) {
                    echo json_encode(array('heading' => 'Error', 'msg' => 'Admin details already exists.'));
                    die;
                } else {
                    $setData['id'] = $RowID;
                    $setData['name'] = $request->input('name');
                ...
                echo json_encode(array('heading' => 'Success', 'msg' => 'Admin details updated successfully'));
                die;
            }
        }
